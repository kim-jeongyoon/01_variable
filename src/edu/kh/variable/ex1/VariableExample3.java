...
public class VariableExample3 {
	...
	//작은 자료형 -> 큰자료형으로 컴파일러에 의해 자동적으로 변환되는 것
	
	int num1 = 10;
	double num2 = 3.5;
	System.out.println(num1 + num2);
	//원래 에러가 발생해야 되지만 '자동 형변환' 덕분에 에러발생X
	...
	System.out.println(d1 + num2); // double + double 형 
	
	// char 문자형 자료형
	// char 자료형은 문자형이지만 실제 저장하는 값은 0부터 6만5천번 사이에 있는 숫자
	char ch = 'V';
	int i3 = ch; // 정수형 int 변수 = char 값 대입 --> int로 자동형변환
